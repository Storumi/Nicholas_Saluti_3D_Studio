Shader "examples/week 9/IBL with fresnel"
{
    Properties 
    {
        ...
        [NoScaleOffset] _displacementSubmap ("displacement Submap", 2D) = "gray" {}
        ...
        _submapScale ("submap Scale", Range(1,1000)) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Interpolators vert (MeshData v)
            {
                ...
                float2 subuv = float2(_submapScale%o.uv.x,_submapScale%o.uv.y);
                float subheight = tex2Dlod(_displacementSubmap, float4(subuv, 0, 0)).r * 2 - 1;
                v.vertex.xyz +=  (v.normal * subheight * _displacementIntensity) * _toggle;
